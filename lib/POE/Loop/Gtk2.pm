...
sub loop_initialize {
  ...
  # Must Gnome2::Program->init() yourselves, as it takes parameters.
  unless (exists $INC{'Gnome2.pm'}) {
    Gtk2->init();
  }
}
...
POE::Loop::Gtk2 - a bridge that supports Gtk2's event loop from POE
